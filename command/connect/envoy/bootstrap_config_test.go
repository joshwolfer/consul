	...
	cases := []testcase{
		...
		},
		{
			...
			expect: map[string][]string{
				...
				"consul.destination.custom_hash":    {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", ""},
				"consul.destination.datacenter":     {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "dc1"},
				"consul.destination.full_target":    {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555"},
				"consul.destination.namespace":      {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "default"},
				"consul.destination.partition":      {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", ""},
				"consul.destination.routing_type":   {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "internal"},
				"consul.destination.service":        {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "bar"},
				"consul.destination.service_subset": {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", ""},
				"consul.destination.target":         {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "exported~bar.default.dc1"},
				"consul.destination.trust_domain":   {"exported~bar.default.dc1.internal.11111111-2222-3333-4444-555555555555.consul.", "11111111-2222-3333-4444-555555555555"},
